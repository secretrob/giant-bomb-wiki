...
describe("Postedit notification", function () {
        ...
        new Map(subtests).forEach((doTestEdit, subTest) => {
                describe("(" + subTest + ")", () => {
                        ...
                        it("should be visible", function () {
                                PostEdit.init();
                                expect(
                                        PostEdit.notification.isDisplayed(),
		...
		*/
                                expect(PostEdit.text).to.not.contain(
                        ...
                        it('should contain "Pending Review" icon', function () {
                                expect(
                                        PostEdit.pendingIcon.isDisplayed(),
                                        "pendingIcon.isDisplayed",
                                ).to.be.true;
                        });
                        ...
                        it('should contain "continue editing" link', function () {
                                expect(
                                        PostEdit.editLink.isDisplayed(),
                                        "editLink.isDisplayed",
                                ).to.be.true;

                                expect(
                                        PostEdit.editLink.query.title,
                                        "editLink.query.title",
                        ...
                        it('shouldn\'t contain "sign up" link if the user is logged in', function () {
                                expect(
                                        PostEdit.signupLink.isDisplayed(),
		...
		*/
                                var ExistingPageName = browser.call(
                                        () => ExistingPagePromise,
                                );
