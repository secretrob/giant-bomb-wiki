...
class PostEdit extends Page {
        get notification() {
                return $(".postedit, .mw-notification");
        }
        ...
        get editLink() {
                return browser.getLink("a=your version of this page");
        }
        get signupLink() {
                return browser.getLink("a=sign up");
        }
	...
	*/
        waitUsualFadeTime() {
                browser.pause(
                        this.usualFadeTime - (Date.now() - this.inittime),
                );
        }
}
