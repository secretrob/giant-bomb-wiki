...
class ModerationTestsuiteMockAutoLoader
{
        ...
        protected function __construct()
        {
                ...
                $this->alreadyMockedClasses = array_fill_keys(
                        $nomockClasses,
                        true,
                );
        }
         ...
         */
        public static function replaceFunction(
                $oldFunctionName,
                $newFunctionName,
        ) {
                $self = self::singleton();
...
spl_autoload_register([
        ModerationTestsuiteMockAutoLoader::singleton(),
        "autoload",
]);
