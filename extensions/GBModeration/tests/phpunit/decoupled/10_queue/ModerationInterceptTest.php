...
class ModerationInterceptTest extends ModerationTestCase
{
        ...
        {
                $sets = [
                        "anonymous edit should be intercepted" => [
                                ["anonymously" => true],
                        ],
                        "edit by unprivileged user should be intercepted" => [
                                ["groups" => []],
                        ],
                ...
                foreach ($sets as $description => $set) {
                        $newSets["$description (API)"] = [
                                $set[0] + ["viaApi" => true],
                        ];
                        $newSets["$description (not API)"] = [
                                $set[0] + ["viaApi" => false],
                        ];
                }
                return $newSets;
                ...
                switch ($this->action) {
                        ...
                        default:
                                throw new MWException(
                                        'Unknown "action" requested in TestSet of ' .
                                                __CLASS__,
                                );
                }
        }
