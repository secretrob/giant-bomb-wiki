...
class ModerationEntryEditTest extends ModerationUnitTestCase
{
        ...
        public function testApprove(array $opt)
        {
                ...
                $warningFromConsequence =
                        $opt["warningFromConsequence"] ?? null;
                ...
                $manager->expects($this->exactly(count($expectedCalls)))
                        ->method("add")
        ...
        public function dataProviderApprove()
        {
                return [
                        ...
                        "successful approval: minor edit" => [
                                ["minor" => true],
                        ],
