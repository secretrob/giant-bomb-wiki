...
(function () {
        ...
        function prepareRow(idx, rowElem) {
                ...
                $row.addClass("modstatus-untouched").prepend(
                        $("<span>").addClass("modicon"),
                );
        }
        ...
        function handleSuccess($rows, q, ret) {
                switch (q.modaction) {
                        ...
                        case "unblock":
                                ...
                                var $links = findLinks($rows, [
                                        "block",
                                        "unblock",
                                ]);
                                $links.attr("data-modaction", newAction).each(
                                        function (idx, linkElem) {
                                                linkElem.href =
                                                        linkElem.href.replace(
                                                                q.modaction,
                                                                newAction,
                                                        );
                                        },
                        ...
                        default:
                                console.log(
                                        'Post-Ajax handler: not implemented for modaction="' +
                                                q.modaction +
                                                '"',
                                );
                }
		...
		*/
                $rows.find("a.modlink-disabled").addClass(
                        "modlink-not-applicable",
                );
        }
        ...
        function runModaction(ev) {
                ...
                if (
                        ...
                        if (action === "approveall" || action === "rejectall") {
                                ...
                                $affectedRows = $affectedRows.not(
                                        ".modstatus-approved,.modstatus-rejected",
                                );
                        }
                }
