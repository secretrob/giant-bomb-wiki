    ...
    public function testProcessPlatformQueryResultsWithValidData(): void
    {
        $results = [
            "Platforms/PlayStation 5" => [
                "fullurl" =>
                    "http://localhost:8080/wiki/Platforms/PlayStation_5",
                "printouts" => [
                    ...
                    "Has image" => [
                        [
                            "fullurl" =>
                                "http://localhost:8080/wiki/images/PlayStation_5.jpg",
                        ],
                    ],
                ],
            ],
    ...
    public function testProcessPlatformQueryResultsWithMultiplePlatforms(): void
    {
        $results = [
            ...
            "Platforms/Xbox Series X" => [
                "fullurl" =>
                    "http://localhost:8080/wiki/Platforms/Xbox_Series_X",
                "printouts" => [
    ...
    public function testProcessPlatformQueryResultsWithMissingOptionalFields(): void
    {
        $results = [
            "Platforms/Minimal Platform" => [
                "fullurl" =>
                    "http://localhost:8080/wiki/Platforms/Minimal_Platform",
                "printouts" => [
    ...
    public function testProcessPlatformQueryResultsFallbackToPageName(): void
    {
        $results = [
            "Platforms/Unknown Platform" => [
                "fullurl" =>
                    "http://localhost:8080/wiki/Platforms/Unknown_Platform",
                "printouts" => [
                    // No Has name field
                ],
            ],
    ...
    public function testProcessPlatformQueryResultsWithMonthDateType(): void
    {
        $results = [
            "Platforms/Month Release Platform" => [
                "fullurl" =>
                    "http://localhost:8080/wiki/Platforms/Month_Release_Platform",
                "printouts" => [
    ...
    public function testProcessPlatformQueryResultsWithQuarterDateType(): void
    {
        $results = [
            "Platforms/Quarter Release Platform" => [
                "fullurl" =>
                    "http://localhost:8080/wiki/Platforms/Quarter_Release_Platform",
                "printouts" => [
    ...
    public function testProcessPlatformQueryResultsWithYearDateType(): void
    {
        $results = [
            "Platforms/Year Release Platform" => [
                "fullurl" =>
                    "http://localhost:8080/wiki/Platforms/Year_Release_Platform",
                "printouts" => [
    ...
    public function testProcessPlatformQueryResultsWithImageUrlCleaning(): void
    {
        $results = [
            "Platforms/Test Platform" => [
                "fullurl" =>
                    "http://localhost:8080/wiki/Platforms/Test_Platform",
                "printouts" => [
                    "Has name" => ["Test Platform"],
                    "Has image" => [
                        [
                            "fullurl" =>
                                "http://localhost:8080/wiki/images/test.jpg",
                        ],
                    ],
                ],
            ],
    ...
    public function testProcessPlatformQueryResultsWithMissingImage(): void
    {
        $results = [
            "Platforms/No Image Platform" => [
                "fullurl" =>
                    "http://localhost:8080/wiki/Platforms/No_Image_Platform",
                "printouts" => [
    ...
    public function testProcessPlatformQueryResultsWithAllFields(): void
    {
        $results = [
            "Platforms/Complete Platform" => [
                "fullurl" =>
                    "http://localhost:8080/wiki/Platforms/Complete_Platform",
                "printouts" => [
                    ...
                    "Has image" => [
                        [
                            "fullurl" =>
                                "http://localhost:8080/wiki/images/complete.jpg",
                        ],
                    ],
                ],
            ],
        ...
        $this->assertSame(
            "A platform with all fields populated",
            $platform["deck"],
        );
        $this->assertSame(
            "http://localhost:8080/wiki/Platforms/Complete_Platform",
    ...
    public function testProcessPlatformQueryResultsWithEmptyPrintouts(): void
    {
        $results = [
            "Platforms/Empty Printouts" => [
                "fullurl" =>
                    "http://localhost:8080/wiki/Platforms/Empty_Printouts",
                "printouts" => [],
            ],
        ];
