...
trait CommonVariablesAndMethods
{
    ...
    protected $map = [
        GiantBombConstants::ASSOC_TYPE_ACCESSORY => [
            "className" => "accessory",
            "plural" => "accessories",
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_CHARACTER => [
            "className" => "character",
            "plural" => "characters",
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_COMPANY => [
            "className" => "company",
            "plural" => "companies",
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_CONCEPT => [
            "className" => "concept",
            "plural" => "concepts",
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_DLC => [
            "className" => "dlc",
            "plural" => "dlc",
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_FRANCHISE => [
            "className" => "franchise",
            "plural" => "franchises",
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_GAME => [
            "className" => "game",
            "plural" => "games",
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_GAME_RATING => [
            "className" => "game_rating",
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_GENRE => [
            "className" => "genre",
            "plural" => "genres",
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_LOCATION => [
            "className" => "location",
            "plural" => "locations",
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_PERSON => [
            "className" => "person",
            "plural" => "people",
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_PLATFORM => [
            "className" => "platform",
            "plural" => "platforms",
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_RATING_BOARD => [
            "className" => "rating_board",
            "plural" => null,
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_REGION => [
            "className" => "region",
            "plural" => null,
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_RELEASE => [
            "className" => "release",
            "plural" => null,
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_THEME => [
            "className" => "theme",
            "plural" => "themes",
            "content" => null,
            "count" => 0,
        ],
        GiantBombConstants::ASSOC_TYPE_THING => [
            "className" => "thing",
            "plural" => "objects",
            "content" => null,
            "count" => 0,
    ...
    protected function createXML(string $filename, array $data): bool
    {
        ...
        foreach ($data as $set) {
            ...
            $model = $dom->createElementNS(
                $mwNamespace,
                "model",
                array_key_exists("model", $set) ? $set["model"] : "wikitext",
            );
            $revision->appendChild($model);

            $format = $dom->createElementNS(
                $mwNamespace,
                "format",
                array_key_exists("format", $set)
                    ? $set["format"]
                    : "text/x-wiki",
            );
    ...
    protected function streamXML(string $filename, array $data)
    {
        ...
        foreach ($data as $page) {
            ...
            $xml->writeElement(
                "model",
                array_key_exists("model", $page) ? $page["model"] : "wikitext",
            );
            $xml->writeElement(
                "format",
                array_key_exists("format", $page)
                    ? $page["format"]
                    : "text/x-wiki",
            );
            ...
            $xml->writeRaw(
                array_key_exists("description", $page)
                    ? $page["description"]
                    : "",
            );
            $xml->endElement();
